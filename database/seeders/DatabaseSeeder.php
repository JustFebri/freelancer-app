...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($data as $index => $value) {
            $category = category::create(['category_name' => $value]);
            foreach ($subData[$index] as $subValue) {
                sub_category::create(['category_id' => $category->category_id, 'subcategory_name' => $subValue]);
            }
        }
        ...
        $formattedData = [];
        foreach ($dataArray as $code => $language) {
            $formattedData = $language['name'] . ' (' . $language['nativeName'] . ')';
            language::create(['language_name' => $formattedData]);
        }
    }
}
